...
\author{Łukasz Warzocha, Mateusz Serafin, Przemysław Sulowski}
\shortauthor{Ł. Warzocha, M. Serafin, P. Sulowski}
\noAlbum{134983, 134969, 134975}

\titlePL{Implementacja algorytmów SI w grze "Czołgi 2D"}
\titleEN{Implementation of Artificial AI in the ,,Tanks 2D'' Game}

\shorttitlePL{Algorytmy SI w grze Czołgi 2D} 
\shorttitleEN{AI Algorithms in Tanks 2D Game}
