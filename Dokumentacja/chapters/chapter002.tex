...
Niezależnie od powyższego, w sytuacji gdy bot mimo wszystko wjedzie w ścianę, stosowany jest drugi mechanizm awaryjny - nagła 
zmiana czołgu do środka kafelka po kolizji ze ścianą.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|l|}
        ...
        Zniszczalna ściana      & 6   & wymaga zniszczenia (czas + pocisk) \\
...
dopóki obejście wymaga mniej niż 6 dodatkowych kafelków. Gdy obejście byłoby znacznie dłuższe, opłaca się zniszczyć 
ścianę. Naturalnie tworzy to zachowanie typu 'Niszcze ściany tylko, gdy to się opłaca'.
...
ściany - zniszczalne traktowane są jak potencjalna 'zasłona dymna' (bot może je zniszczyć strzałem, 
...
(zniszczalne i niezniszczalne). Logika ta zapobiega marnowaniu pocisków, które zniszczyłyby  ścianę, ale nie trafiłyby w gracza.
...
\begin{itemize}
\item Rotacja czołgu do środka kafelka - gdy bot po zniszczalnej kolizji wciąż znajduje się wewnątrz ściany 
...
z której nie dało się wyjść, ponieważ 34-pikselowy hitbox w rogu zawsze styka się 
ze ścianami sąsiednich kafelków. 

Rozwiązanie: Rotacja czołgu do środka kafelka (współrzędne typu 20 + 40k), a nie do rogu - tylko środek kafelka gwarantuje, 
